...
ventana_chat.insert(tk.END, "Chatbot: ¡Hola! Pregunta sobre cálculo: derivadas, integrales, límites o el teorema fundamental o sobre referencias o ¿Qué temas siguen?.\n")
